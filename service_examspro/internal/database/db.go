...
func SeedSystemSettings(db *gorm.DB) {
	defaults := []models.SystemSetting{
		...
		{ID: "referral_bonus", Value: "25", Type: "number", SettingGroup: "Economy", Label: "Referral Bonus (Signup)", Desc: "Bonus coins for the referrer upon signup"},
		{ID: "referral_coin_reward", Value: "50", Type: "number", SettingGroup: "Economy", Label: "Referral Coins (Converted)", Desc: "Bonus coins when a referral buys a plan"},
		{ID: "referral_fiat_percent", Value: "10", Type: "number", SettingGroup: "Economy", Label: "Referral Cash Percentage", Desc: "Percentage of the first purchased plan price awarded to the referrer as cash"},
