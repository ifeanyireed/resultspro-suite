...
export const NIGERIAN_STATES_LGAS: StateLGA[] = [
  ...
  {
    state: "Adamawa",
    lgas: ["Demsa", "Fufure", "Ganye", "Guyuk", "Girei", "Gombi", "Hong", "Jada", "Lamurde", "Madagali", "Maiha", "Mayo Belwa", "Michika", "Mubi North", "Mubi South", "Numan", "Shelleng", "Song", "Toungo", "Yola North", "Yola South"]
  },
  {
    state: "Akwa Ibom",
    lgas: ["Abak", "Eastern Obolo", "Eket", "Esit Eket", "Essien Udim", "Etim Ekpo", "Etinan Uyo", "Ibeno", "Ibesikpo Asutan", "Ibiono-Ibom", "Ika", "Ikono", "Ikot Abasi (village)", "Ikot Ekpene", "Ini", "Itu", "Mbo", "Mkpat-Eni", "Nsit-Atai", "Nsit-Ibom", "Nsit-Ubium", "Obot Akara", "Okobo", "Onna", "Oron", "Oruk Anam", "Udung-Uko", "Ukanafun", "Uruan", "Urue-Offong/Oruko", "Uyo"]
  },
  {
    state: "Anambra",
  ...
  {
    state: "Ebonyi",
    lgas: ["Abakaliki", "Afikpo", "Edda", "Ebonyi", "Ezza North", "Ezza South", "Ikwo", "Ishielu", "Ivo", "Izzi", "Ohaozara", "Ohaukwu", "Onicha"]
  },
  {
    state: "Edo",
  ...
  {
    state: "Imo",
    lgas: ["Aboh Mbaise", "Ahiazu Mbaise", "Ehime Mbano", "Ezinihitte", "Ideato North", "Ideato South", "Ihitte/Uboma", "Ikeduru", "Isiala Mbano", "Isu", "Mbaitoli", "Ngor Okpala", "Njaba", "Nkwerre", "Nwangele", "Obowo", "Oguta", "Ohaji/Egbema", "Okigwe", "Orlu", "Orsu", "Oru East", "Oru West", "Owerri Municipal", "Owerri North", "Owerri West", "Onuimo"]
  },
  {
    state: "Jigawa",
    lgas: ["Auyo", "Babura", "Birniwa", "Birnin Kudu", "Buji", "Dutse", "Gagarawa", "Garki", "Gumel", "Guri", "Gwaram", "Gwiwa", "Hadejia", "Jahun", "Kafin Hausa", "Kaugama", "Kazaure", "Kiri Kasama", "Kiyawa", "Maigatari", "Malam Madori", "Miga", "Ringim", "Roni", "Sule Tankarkar", "Taura", "Yankwashi"]
  },
  {
    state: "Kaduna",
  ...
  {
    state: "Kebbi",
    lgas: ["Aleiro", "Arewa", "Argungu", "Augie", "Bagudo", "Birnin Kebbi", "Bunza", "Dandi", "Fakai", "Gwandu", "Jega", "Kalgo", "Koko / Besse", "Maiyama", "Ngaski", "Sakaba", "Shanga", "Suru", "Wasagu / Danko", "Yauri", "Zuru"]
  },
  {
    state: "Kogi",
    lgas: ["Adavi", "Ajaokuta", "Ankpa", "Bassa", "Dekina", "Ibaji", "Idah", "Igalamela-Odolu", "Kabba/Bunu", "Mopa-Muro", "Ijumu", "Yagba West", "Yagba East", "Ofu", "Okene", "Okehi", "Lokoja", "Isanlu", "Olamaboro", "Omala", "Kogi"]
  },
  {
    state: "Kwara",
    lgas: ["Ekiti", "Ifelodun", "Ilorin East", "Ilorin West", "Irepodun", "Isin", "Kaiama", "Moro", "Offa", "Oke Ero", "Oyun", "Pategi", "Baruten", "Asa", "Edu", "Ilorin South"]
  },
  {
    state: "Lagos",
  ...
  {
    state: "Nasarawa",
    lgas: ["Akwanga", "Awe", "Doma", "Karu", "Lafia", "keana", "Obi", "Kokona", "Keffi", "Nasarawa", "Nasarawa Eggon", "Wamba", "Toto"]
  },
  {
    state: "Niger",
  ...
  {
    state: "Ogun",
    lgas: ["Abeokuta North", "Abeokuta South", "Ado-Odo/Ota", "Ewekoro", "Ifo", "Ijebu North", "Ijebu North East", "Ijebu Ode", "Ijebu East", "Ilishan-Remo", "Ikenne", "Imeko Afon", "Ipokia", "Obafemi Owode", "Odeda", "Odogbolu", "Ogun Waterside", "Remo North", "Shagamu", "Yewa North", "Yewa South", "Isara"]
  },
  {
    state: "Ondo",
    lgas: ["Akoko North-East", "Akoko North-West", "Akoko South-East", "Akoko South-West", "Akure North", "Akure South", "Ese Odo", "Ifedore", "Idanre", "Ilaje", "Ile-Oluji/Okeigbo", "Irele", "Odigbo", "Okitipupa", "Ondo West", "Ondo East", "Ose", "Owo"]
  },
  {
    state: "Osun",
    lgas: ["Aiyedaade", "Aiyedire", "Atakunmosa East", "Atakunmosa West", "Boluwaduro", "Boripe", "Ede North", "Ede South", "Egbedore", "Ejigbo", "Ife Central", "Ife East", "Ife North", "Ife South", "Ifedayo", "Ifelodun", "Isokan", "Obokun", "Irewole", "Ola-Oluwa", "Olorunda", "Ilesa West", "Ilesa East", "Odo-Otin", "Ila", "Ori-Ade", "Orolu", "Irepodun", "Iwo", "Osogbo"]
  },
  {
    state: "Oyo",
    lgas: ["Afijio", "Ibadan North", "Ibadan North-East", "Ibadan North-West", "Ibadan South-East", "Ibadan South-West", "Ibarapa Central", "Ibarapa East", "Ibarapa North", "Ido", "Irepo", "Iwajowa", "Ogbomosho North", "Ogbomosho South", "Ogo Oluwa", "Olorunsogo", "Oluyole", "Ona Ara", "Orelope", "Orire", "Atisbo", "Saki West", "Saki East", "Egbeda", "Lagelu", "Atiba", "Oyo East", "Oyo West"]
  },
  {
    state: "Plateau",
  ...
  {
    state: "Rivers",
    lgas: ["Abua-Odual", "Ahoada East", "Ahoada West", "Akuku Toru", "Andoni", "Asari Toru", "Bonny", "Degema", "Eleme", "Emohua", "Etche", "Gokana", "Ikwerre", "Khana", "Obio-Akpor", "Ogba-Egbema-Ndoni", "Ogu-Bolo", "Okirika", "Omuma", "Opobo-Nkoro", "Oyigbo", "Port Harcourt", "Tai"]
  },
  {
    state: "Sokoto",
    lgas: ["Binji", "Bodinga", "Dange Shuni", "Gada", "Sokoto South", "Sokoto North", "Gwadabawa", "Wamakko", "Tangaza", "Sabon Birni", "Isah", "Rabah", "Silame", "Wurno", "Goronyo", "Illela", "Gudu", "Tureta", "Tambuwal", "Kware"]
  },
  {
    state: "Taraba",
  ...
  {
    state: "Zamfara",
    lgas: ["Anka", "Bakuka", "Birnin Magaji/Kiyaw", "Bukkuyum", "Bungudu", "Tsafe", "Gummi", "Gusau", "Kaura-Namoda", "Maradun", "Maru", "Shinkafi", "Talata-Mafara", "Zurmi"]
  },
  {
    state: "Federal Capital Territory",
    lgas: ["Abaji", "Abuja Municipal Area Council", "Kwali", "Kuje", "Bwari", "Gwagwalada"]
  }
];

export const STATES = NIGERIAN_STATES_LGAS.map(item => item.state).sort();

export const getLGAsByState = (state: string): string[] => {
  const stateData = NIGERIAN_STATES_LGAS.find(item => item.state === state);
