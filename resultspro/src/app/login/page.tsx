    ...
    <div className="min-h-screen w-full flex">
      ...
      <div className="hidden lg:flex w-[55%] relative overflow-hidden bg-[#0B1021]">
        ...
        <div className="relative z-10 w-full h-full flex flex-col justify-between p-16">
          ...
          <div className="flex items-center space-x-3">
            <Image src="/logo.png" alt="ResultsPRO" width={64} height={64} className="object-contain" priority />
            <div>
              <h1 className="font-bold text-white text-3xl tracking-tight">ResultsPRO</h1>
      ...
      <div className="w-full lg:w-[45%] bg-white flex items-center justify-center p-8 sm:p-16 relative">
        ...
        <div className="absolute top-8 left-8 lg:hidden flex items-center space-x-2">
           <Image src="/logo.png" alt="ResultsPRO" width={48} height={48} className="bg-slate-900 rounded-lg p-1" />
