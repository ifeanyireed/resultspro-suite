        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="flex flex-col flex-1 overflow-hidden">
              <div className="p-6 space-y-4 overflow-y-auto flex-1">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
                    placeholder="e.g. The premier autumn batch"
                  />
                </div>
              ...
              <div className="px-6 py-4 flex justify-between items-center border-t border-slate-100 shrink-0">
                <div>
                  {cohort && (
                    <button
                      type="button"
                      ...
                      onClick={async () => {
                        if (confirm('Are you sure you want to delete this cohort?')) {
                          setLoading(true);
                          try {
                            await coursesApi.delete(`/api/admin/cohorts/${cohort.id}`);
                            onSave();
                          } catch (err) {
