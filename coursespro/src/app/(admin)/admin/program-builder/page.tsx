        ...
        <div className="bg-white rounded-[1.5rem] p-6 shadow-sm border border-gray-100 flex flex-col">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between p-4 rounded-xl bg-gray-50 border border-gray-100">
              ...
              <span className="text-lg font-bold text-green-600">{programs.filter((p: any) => p.status === 'published').length}</span>
            </div>
            <div className="flex items-center justify-between p-4 rounded-xl bg-gray-50 border border-gray-100">
              <div className="flex items-center gap-3">
                <DocumentDuplicateIcon className="w-5 h-5 text-gray-500" />
              ...
              <span className="text-lg font-bold text-gray-900">{programs.filter((p: any) => p.status !== 'published').length}</span>
            </div>
          </div>
        </div>
      </div>
