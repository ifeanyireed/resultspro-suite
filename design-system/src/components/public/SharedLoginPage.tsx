      ...
      <div className="hidden lg:flex w-[55%] relative overflow-hidden bg-[#0B1021]">
        ...
        <div className="relative z-10 w-full h-full flex flex-col justify-between p-16">
          ...
          <div className="flex items-center space-x-3">
            <Image src={logoSrc} alt="ResultsPRO" width={64} height={64} className="object-contain" priority />
            <div>
              <h1 className="font-bold text-white text-3xl tracking-tight">ResultsPRO</h1>
              <p className="text-blue-400 font-semibold text-xs uppercase tracking-widest">{appName}</p>
            </div>
          </div>
