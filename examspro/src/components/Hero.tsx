...
import { IconCheck, IconPlay, IconBook, IconBrain } from '@tabler/icons-react';
        ...
        >
          ...
          <motion.div variants={staggerItem} style={{ marginBottom: '1.5rem' }}>
            <span className="overline-dark">
              Nigeria's Premier Prep Platform
            </span>
          </motion.div>
          ...
          <motion.p variants={staggerItem} style={{ 
            ...
            Professional, gamified CBT practice solutions for WAEC, JAMB, NECO, and international examinations.
          </motion.p>

          {/* CTAs */}
          <motion.div variants={staggerItem} style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginBottom: '2rem', alignItems: 'center' }}>
            <Link href="/practice" className="btn btn-red btn-lg">
              Start Practicing
            </Link>
            <Link href="/battle-mode" className="btn btn-outline-white btn-lg">
              Enter Battle Mode
            </Link>
          </motion.div>
          ...
          >
            ...
            <form aria-label="Quick Access" style={{ display: 'flex', flexDirection: 'column', gap: '0.875rem' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem', marginTop: '1rem' }}>
                <Link href="/practice" className="btn btn-outline-white" style={{ width: '100%', justifyContent: 'center' }}>
                  <IconBook size={18} /> Solo
                </Link>
                <Link href="/battle-mode" className="btn btn-red" style={{ width: '100%', justifyContent: 'center', border: 'none' }}>
