    ...
    <div className="flex-1 overflow-y-auto p-8 bg-navy">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-3xl font-display font-black text-white">Create New Post</h1>
          <Button 
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="p-6 rounded-3xl bg-blue/5 border border-blue/10">
                <h4 className="text-blue text-sm font-bold mb-2">Pro Tip</h4>
                <p className="text-xs text-blue/70 leading-relaxed">
                  Use clear, descriptive titles for better SEO. You can use the WYSIWYG editor for professional formatting.
                </p>
              </div>
            </div>
          </div>
