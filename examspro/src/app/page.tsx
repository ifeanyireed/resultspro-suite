...
export default function Home() {
  return (
    <main>
      ...
      <section className="section-py bg-light">
        <div className="container-nets">
          <div style={{ marginBottom: '4rem', maxWidth: '600px' }}>
            <div className="overline" style={{ marginBottom: '1rem' }}>Our Programmes</div>
            <h2 className="text-d4 fw-400">Comprehensive exam coverage.</h2>
          </div>
      ...
      {/* Why ExamsPRO (Mimicking WhyNETS) */}
      <section className="section-py bg-white border-y border-nets-border">
        <div className="container-nets">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="overline" style={{ marginBottom: '1rem' }}>The Coin Economy</div>
              <h2 className="text-d3 fw-300 mb-6">Earn as you learn.</h2>
              <p className="text-body-lg text-muted mb-8">
                Spend coins on AI deep-dives, unlocking past questions, or entering high-stakes battles.
