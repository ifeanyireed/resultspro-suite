        ...
        <div className="flex-1 flex flex-col bg-white rounded-[40px] border border-slate-200 shadow-sm backdrop-blur-xl backdrop-saturate-[1.2] shadow-xl overflow-hidden relative">
          ...
          {!user && mounted ? (
            <div className="absolute inset-0 z-20 bg-white/80 backdrop-blur-md flex items-center justify-center p-8 text-center">
              <div className="max-w-sm space-y-6">
                ...
                <h3 className="text-2xl font-bold text-[#0f172a]">Unlock Your AI Tutor</h3>
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <Button 
                    ...
                    variant="ghost" 
                    className="w-full text-gray-500 hover:text-[#0f172a]"
                  >
                    Create Free Account
                  </Button>
                </div>
          ...
          <div className="p-6 border-b border-slate-200 shadow-sm flex items-center justify-between bg-white">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-[#0f172a] font-bold leading-none mb-1">Study Assistant</h2>
          ...
          >
            {messages.length === 0 && (
              <div className="h-full flex flex-col items-center justify-center text-center space-y-6 opacity-50 px-10">
                ...
                <div className="space-y-2">
                  <h3 className="text-[#0f172a] text-xl font-bold">How can I help you today?</h3>
          ...
          <div className="p-6 bg-white border-t border-slate-200">
            ...
            >
              <input 
                ...
                disabled={isLoading}
                className="w-full bg-white border border-slate-200 rounded-2xl py-5 pl-6 pr-16 text-[#0f172a] focus:outline-none focus:border-red-600/50 transition-all placeholder:text-gray-600"
              />
              <button 
                type="submit"
