  ...
  return (
    <main className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] ${isWinner ? 'bg-secondary/10' : 'bg-primary/10'} rounded-full blur-[120px] animate-pulse`} />
      </div>
      ...
      <div className="relative z-10 w-full max-w-2xl text-center">
        ...
        <div className="mb-12 animate-in zoom-in duration-500">
          <div className={`
            ...
            ${isWinner ? 'bg-secondary text-secondary-foreground rotate-12 shadow-[0_0_50px_rgba(0,200,83,0.5)]' : 'bg-primary text-primary-foreground -rotate-12 shadow-[0_0_50px_rgba(239,68,68,0.5)]'}
          `}>
        ...
        <div className="flex items-center justify-center gap-4 mb-12">
          <div className="flex flex-col items-center gap-3">
            <div className={`p-1 rounded-2xl border-2 flex items-center justify-center text-2xl font-bold w-16 h-16 ${isWinner ? 'border-secondary bg-secondary/10 text-secondary' : 'border-gray-200  bg-slate-100'}`}>
        ...
        <div className="p-8 rounded-[40px] bg-white border border-gray-200  backdrop-blur-xl backdrop-saturate-[1.2] shadow-[0_8px_32px_0_rgba(0,0,0,0.36)] shadow-[inset_0_1px_0_rgba(255,255,255,0.1)] mb-12 relative overflow-hidden group">
          ...
          <div className="grid grid-cols-2 gap-8 divide-x divide-white/5">
            <div>
              ...
              <div className={`flex items-center justify-center gap-2 text-3xl font-display font-black ${isWinner ? 'text-primary' : 'text-primary'}`}>
            ...
            <div>
              ...
              <div className={`flex items-center justify-center gap-2 text-3xl font-display font-black ${isWinner ? 'text-secondary' : 'text-primary'}`}>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/battle-mode">
             <Button className="w-full sm:w-auto py-7 px-10 rounded-2xl bg-secondary text-secondary-foreground hover:bg-secondary/90 font-bold text-lg flex items-center gap-2 group shadow-xl shadow-secondary/10">
