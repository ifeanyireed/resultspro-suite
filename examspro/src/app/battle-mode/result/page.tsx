  ...
  return (
    <main className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] ${isWinner ? 'bg-green-500/10' : 'bg-red-500/10'} rounded-full blur-[120px] animate-pulse`} />
      </div>
      ...
      <div className="relative z-10 w-full max-w-2xl text-center">
        ...
        <div className="mb-12 animate-in zoom-in duration-500">
          <div className={`
            ...
            ${isWinner ? 'bg-green-500 text-white rotate-12 shadow-[0_0_50px_rgba(0,200,83,0.5)]' : 'bg-red-500 text-white -rotate-12 shadow-[0_0_50px_rgba(239,68,68,0.5)]'}
          `}>
            {isWinner ? <Trophy className="w-12 h-12" /> : <XCircle className="w-12 h-12" />}
          </div>
          <h1 className="text-5xl md:text-7xl font-display font-black italic tracking-tighter text-gray-900 mb-2 uppercase">
        ...
        <div className="flex items-center justify-center gap-4 mb-12">
          <div className="flex flex-col items-center gap-3">
            <div className={`p-1 rounded-2xl border-2 flex items-center justify-center text-2xl font-bold w-16 h-16 ${isWinner ? 'border-green bg-green-500/10 text-green-500' : 'border-gray-200  bg-slate-100'}`}>
          ...
          <div className="flex flex-col items-center gap-2">
            <div className="text-2xl font-display font-black text-gray-300 italic">VS</div>
            <div className="h-px w-12 bg-gray-200" />
          </div>

          <div className="flex flex-col items-center gap-3">
             <div className={`p-1 rounded-2xl border-2 flex items-center justify-center text-2xl font-bold w-16 h-16 ${!isWinner && opponentStats ? 'border-red-500 bg-red-500/10 text-red-500' : 'border-gray-200  bg-slate-100'}`}>
        ...
        <div className="p-8 rounded-[40px] bg-white border border-gray-200  backdrop-blur-xl backdrop-saturate-[1.2] shadow-[0_8px_32px_0_rgba(0,0,0,0.36)] shadow-[inset_0_1px_0_rgba(255,255,255,0.1)] mb-12 relative overflow-hidden group">
          ...
          <div className="grid grid-cols-2 gap-8 divide-x divide-white/5">
            <div>
              ...
              <div className={`flex items-center justify-center gap-2 text-3xl font-display font-black ${isWinner ? 'text-amber-500' : 'text-red-500'}`}>
            ...
            <div>
              ...
              <div className={`flex items-center justify-center gap-2 text-3xl font-display font-black ${isWinner ? 'text-green-500' : 'text-red-500'}`}>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link href="/battle-mode">
             <Button className="w-full sm:w-auto py-7 px-10 rounded-2xl bg-green-500 text-white hover:bg-green-500/90 font-bold text-lg flex items-center gap-2 group shadow-xl shadow-green/10">
