...
export default function SupportPage() {
  ...
  return (
    <main style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', background: 'var(--color-nets-light)' }}>
      ...
      <section style={{ padding: '80px 0', background: 'var(--color-nets-light)' }}>
        <div className="container-nets">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(12, 1fr)', gap: '4rem' }}>
            
            <div style={{ gridColumn: 'span 12' }} className="lg:col-span-8">
              <h2 className="h3" style={{ color: 'var(--color-nets-navy-dark)', marginBottom: '2rem' }}>Frequently Asked Questions</h2>
            ...
            <div style={{ gridColumn: 'span 12' }} className="lg:col-span-4">
              <div style={{ position: 'sticky', top: '120px' }}>
                ...
                <div>
                  ...
                  <p style={{ color: 'var(--color-nets-navy-dark)', fontSize: '0.875rem', lineHeight: 1.6 }}>
                    Lagos, Nigeria
                  </p>
                </div>
              </div>
