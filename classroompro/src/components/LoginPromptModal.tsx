...
import { IconX as X, IconBolt as Zap, IconTrophy as Trophy, IconChartBar as BarChart3, IconArrowRight as ArrowRight, IconLoader2 as Loader2 } from '@tabler/icons-react';
