...
import { IconX as X, IconBolt as Zap, IconTrophy as Trophy, IconBarChart3 as BarChart3, IconArrowRight as ArrowRight, IconLoader2 as Loader2 } from '@tabler/icons-react';
      ...
      >
        <div className="pointer-events-auto relative w-full max-w-md rounded-[32px] overflow-hidden border border-white/10 shadow-2xl
          ...
          <div className="relative z-10 p-8">
            ...
            <div className="text-center mb-8">
              <div className="flex justify-center mb-3">
                 <div className="inline-flex items-center justify-center gap-2 px-3 py-1 bg-green/10 text-green rounded-full border border-green/20 text-xs font-bold uppercase tracking-wider mb-2">
                   <BarChart3 className="w-3.5 h-3.5" /> Track Progress
                 </div>
              </div>
              <h2
              ...
              <p className="text-gray-400 leading-relaxed">
                Sign in to save your progress, access all notes, take quizzes, and master your subjects.
              </p>
            </div>
            ...
            <div className={`grid ${googleClientId && process.env.NEXT_PUBLIC_ENABLE_MICROSOFT_AUTH === 'true' ? 'grid-cols-2' : 'grid-cols-1'} gap-3 mb-3`}>
                {googleClientId && (
                  <GoogleLoginButton 
                ...
                {process.env.NEXT_PUBLIC_ENABLE_MICROSOFT_AUTH === 'true' && (
                  <button
                    ...
                    disabled={isLoading}
                    className="flex items-center justify-center gap-2 py-4 rounded-2xl bg-white/5 border border-white/[0.1] border-t-white/[0.15] text-white font-bold text-sm hover:bg-white/10 transition-all active:scale-[0.98] disabled:opacity-60 shadow-lg"
                  >
