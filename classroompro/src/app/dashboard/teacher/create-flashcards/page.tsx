...
import { IconPlus as Plus, IconTrash2 as Trash2, IconDeviceFloppy as Save, IconChevronLeft as ChevronLeft, IconStack2 as Layers, IconSparkles as Sparkles } from '@tabler/icons-react';
    ...
    <div className="flex-1">
      ...
      <main className="p-8 max-w-5xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          ...
          <Button className="bg-blue hover:bg-blue/90 text-white font-bold">
        ...
        <div className="space-y-8">
          <div className="bg-white/5 border border-white/10 rounded-[32px] p-8 space-y-6">
            <div className="flex items-center gap-4 mb-2">
               ...
               <div className="flex-1">
                  ...
                  />
                  <p className="text-xs text-muted-foreground">Give your flashcard deck a descriptive name.</p>
               </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
             <div className="p-12 text-center border-2 border-dashed border-white/5 rounded-[40px] bg-white/[0.02] flex flex-col items-center justify-center group hover:border-blue/30 transition-all cursor-pointer">
                <Plus className="w-10 h-10 text-white/10 mb-4 group-hover:text-blue group-hover:scale-110 transition-all" />
                <h4 className="text-white font-bold mb-1">Add Card Manually</h4>
                <p className="text-[10px] text-muted-foreground">Create cards one by one</p>
             </div>
             
             <div className="p-12 text-center border-2 border-dashed border-white/5 rounded-[40px] bg-blue/5 flex flex-col items-center justify-center group hover:bg-blue/10 transition-all cursor-pointer">
                <Sparkles className="w-10 h-10 text-blue/40 mb-4 group-hover:scale-110 transition-all" />
                <h4 className="text-blue font-bold mb-1">AI Deck Generator</h4>
                <p className="text-[10px] text-blue/60 uppercase font-black tracking-tighter">Premium</p>
                <p className="text-[10px] text-blue/40 mt-2">Generate deck from your notes</p>
             </div>
          </div>
        </div>
      </main>
