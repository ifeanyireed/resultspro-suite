...
import { IconSearch as Search, IconMessage as MessageSquare, IconSend as Send, IconCircleCheck as CheckCircle2, IconPhone as Phone, IconVideo as Video, IconDotsVertical as MoreVertical } from '@tabler/icons-react';
        ...
        <div className="w-full md:w-80 border-r border-gray-100 bg-[#146ef5]/30 flex flex-col">
          <div className="p-6 space-y-4">
             <div className="relative">
                ...
                <Input placeholder="Search messages..." className="pl-9 bg-white shadow-sm border border-gray-100 border-gray-100 h-10 text-sm" />
             </div>
             <div className="flex gap-2">
                <button className="px-4 py-1.5 rounded-full bg-emerald-600 text-white font-bold text-[10px] uppercase tracking-widest">All</button>
                <button className="px-4 py-1.5 rounded-full bg-white shadow-sm border border-gray-100 text-gray-500 font-bold text-[10px] uppercase tracking-widest hover:text-gray-900 transition-colors">Parents</button>
                <button className="px-4 py-1.5 rounded-full bg-white shadow-sm border border-gray-100 text-gray-500 font-bold text-[10px] uppercase tracking-widest hover:text-gray-900 transition-colors">Students</button>
             </div>
          </div>
           ...
           <div className="flex-1 overflow-y-auto p-8 space-y-6 no-scrollbar">
              ...
              <div className="flex items-start gap-4 max-w-2xl text-sm">
                 ...
                 <div className="space-y-2">
                    ...
                    <span className="text-[10px] text-gray-500 font-medium">10:20 AM</span>
                 </div>
              </div>
              ...
              <div className="flex items-start gap-4 max-w-2xl ml-auto flex-row-reverse text-sm">
                 ...
                 <div className="space-y-2 text-right">
                    ...
                    <div className="flex items-center justify-end gap-1.5 text-[10px] text-gray-500 font-medium">
                       10:22 AM <CheckCircle2 className="w-3 h-3 text-emerald-600" />
                    </div>
                 </div>
              </div>
              ...
              <div className="flex items-start gap-4 max-w-2xl text-sm">
                 ...
                 <div className="space-y-2">
                    ...
                    <span className="text-[10px] text-gray-500 font-medium">10:24 AM</span>
                 </div>
              </div>
           </div>
