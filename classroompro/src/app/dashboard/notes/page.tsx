        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
           <div className="bg-white shadow-sm border border-gray-100 p-6 rounded-[32px] flex items-center gap-4 relative overflow-hidden group">
              ...
              <div>
                 ...
                 <div className="text-[10px] text-gray-500 uppercase font-bold tracking-widest">Total Notes</div>
              </div>
           </div>
           <div className="bg-white shadow-sm border border-gray-100 p-6 rounded-[32px] flex items-center gap-4 relative overflow-hidden group">
           ...
           <div className="bg-white shadow-sm border border-gray-100 p-6 rounded-[32px] flex items-center gap-4 relative overflow-hidden group">
              ...
              <div>
                 ...
                 <div className="text-[10px] text-gray-500 uppercase font-bold tracking-widest">Completed</div>
              </div>
           </div>
           <div className="bg-white shadow-sm border border-gray-100 p-6 rounded-[32px] flex items-center gap-4 relative overflow-hidden group">
              ...
              <div>
                 ...
                 <div className="text-[10px] text-gray-500 uppercase font-bold tracking-widest">Total Subjects</div>
              </div>
           </div>
        </div>
           ...
           <div className="lg:col-span-3 space-y-8">
              ...
              <div className="bg-white shadow-sm border border-gray-100 rounded-[32px] p-6">
                 <div className="flex items-center justify-between mb-6">
                    <h3 className="font-bold text-gray-900 text-sm">Subjects</h3>
                 ...
                 <div className="space-y-1">
                    <button 
                      ...
                      className={cn(
                        ...
                        !selectedSubjectId ? "bg-emerald-600 text-white shadow-lg shadow-green/10" : "text-gray-500 hover:bg-gray-50 hover:text-gray-900"
                      )}
                    >
                    ...
                    {subjectStats.map((stat: any) => (
                      <button 
                        ...
                        className={cn(
                          "w-full flex items-center justify-between p-3 rounded-2xl text-xs font-bold transition-all",
                          selectedSubjectId === stat.id ? "bg-emerald-600 text-white shadow-lg shadow-green/10" : "text-gray-500 hover:bg-gray-50 hover:text-gray-900"
                        )}
                      >
              ...
              {/* Progress Summary */}
              <div className="bg-white shadow-sm border border-gray-100 rounded-[32px] p-6 overflow-hidden relative">
                 <div className="absolute top-0 right-0 w-32 h-32 bg-emerald-600/5 blur-3xl rounded-full -mr-16 -mt-16" />
                 <h3 className="font-bold text-gray-900 text-sm mb-6">Your Progress</h3>
                 <div className="space-y-6 relative z-10">
                    <div className="flex items-center gap-4">
                       ...
                       <div className="flex-1">
                          <p className="text-[10px] text-gray-500 uppercase font-bold tracking-widest">Overall Mastery</p>
                    ...
                    <div className="p-4 rounded-2xl bg-white shadow-sm border border-gray-100 border border-white/5">
           ...
           <div className="lg:col-span-9 space-y-6">
              ...
              <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
                 <div className="relative flex-1 w-full">
                    ...
                    <Input 
                      ...
                      className="pl-11 h-12 bg-white shadow-sm border border-gray-100 border-gray-100 rounded-2xl text-gray-900" 
                      value={search}
                 ...
                 <div className="flex gap-2 w-full md:w-auto">
                    <Select value={selectedStatus} onValueChange={setSelectedStatus}>
                       <SelectTrigger className="h-12 bg-white shadow-sm border border-gray-100 border-gray-100 rounded-2xl text-gray-900 px-6 w-full md:w-40">
              ...
              <div className="space-y-4">
                 {currentNotes.length === 0 ? (
                    <div className="py-32 flex flex-col items-center justify-center text-center space-y-6 bg-white shadow-sm border border-gray-100 rounded-[40px] border border-gray-100 border-dashed">
                       <div className="w-20 h-20 rounded-full bg-white shadow-sm border border-gray-100 flex items-center justify-center text-gray-600">
                       ...
                       <Button 
                         variant="outline" 
                         className="border-gray-100 text-gray-900 font-bold h-11 px-8 rounded-xl"
                         onClick={() => {
                           setSearch("");
                    ...
                    currentNotes.map((note) => (
                      <Link key={note.id} href={`/dashboard/notes/${note.id}`}>
                        <div className="p-6 rounded-[32px] bg-white/[0.02] border border-white/[0.05] border-t-white/[0.1] hover:bg-white/[0.05] hover:border-gray-200 transition-all group flex items-center justify-between relative overflow-hidden">
                           <div className="flex items-center gap-6">
                              <div className="w-14 h-14 rounded-2xl bg-white shadow-sm border border-gray-100 border border-white/5 flex items-center justify-center text-2xl group-hover:scale-110 transition-transform">
                                 {getSubjectStyle(note.topic?.subject?.name || "")}
                              </div>
                              <div>
                                 <div className="flex items-center gap-3 mb-1">
                                    <h4 className="font-bold text-gray-900 group-hover:text-emerald-600 transition-colors">{note.title}</h4>
                                    {note.isNew && <span className="px-2 py-0.5 rounded-full bg-blue/20 text-[#146ef5] text-[8px] font-black uppercase tracking-tighter">New</span>}
                                    {note.completed && <span className="px-2 py-0.5 rounded-full bg-emerald-100 text-emerald-600 text-[8px] font-black uppercase tracking-tighter">Mastered</span>}
                                 </div>
                           ...
                           <div className="flex items-center gap-8">
                              <div className="hidden md:flex items-center gap-4">
                                 <div className="text-right">
                                    <p className="text-[10px] text-gray-500 uppercase font-bold tracking-widest mb-1">Mastery</p>
                                    <div className="flex items-center gap-2">
                                       <div className="w-24 h-1.5 bg-white shadow-sm border border-gray-100 rounded-full overflow-hidden">
                                          <div 
                                            className="h-full bg-emerald-600 transition-all duration-1000" 
                                            style={{ width: note.completed ? "100%" : "40%" }}
                                          />
                                       </div>
                                       <span className="text-[10px] font-bold text-gray-900">{note.completed ? "100%" : "40%"}</span>
                                    </div>
                                 </div>
                              </div>
                              <div className="w-10 h-10 rounded-xl bg-white shadow-sm border border-gray-100 flex items-center justify-center text-gray-500 group-hover:bg-emerald-600 group-hover:text-white transition-all">
