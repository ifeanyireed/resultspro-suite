    ...
    <div className="flex-1 pb-12">
      ...
      <main className="p-8 max-w-5xl mx-auto space-y-12">
        ...
        <div className="text-center space-y-6 py-8">
           <h2 className="text-4xl font-bold text-gray-900 font-display">How can we help you?</h2>
           <div className="relative max-w-2xl mx-auto">
              <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-500" />
              <Input 
                 placeholder="Search for articles, guides or tutorials..." 
                 className="pl-12 h-14 bg-white shadow-sm border border-gray-100 border-gray-100 text-gray-900 rounded-2xl shadow-2xl focus-visible:ring-green/50"
              />
           </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
           <div className="p-8 rounded-[32px] bg-white shadow-sm border border-gray-100 hover:border-blue/50 transition-all group cursor-pointer">
              <div className="w-12 h-12 rounded-2xl bg-blue-50 flex items-center justify-center text-[#146ef5] mb-6 group-hover:scale-110 transition-transform">
                 <Book className="w-6 h-6" />
              </div>
              <h3 className="text-lg font-bold text-gray-900 mb-2">User Guides</h3>
              <p className="text-xs text-gray-500 leading-relaxed">Step-by-step instructions on how to use every feature of the platform.</p>
           </div>
           <div className="p-8 rounded-[32px] bg-white shadow-sm border border-gray-100 hover:border-green/50 transition-all group cursor-pointer">
              ...
              <p className="text-xs text-gray-500 leading-relaxed">Watch quick 2-minute videos covering onboarding, quizzes, and note-taking.</p>
           </div>
           <div className="p-8 rounded-[32px] bg-white shadow-sm border border-gray-100 hover:border-amber/50 transition-all group cursor-pointer">
              ...
              <p className="text-xs text-gray-500 leading-relaxed">Chat with our support team for immediate assistance with any issues.</p>
           </div>
        </div>

        {/* FAQ Section */}
        <div className="space-y-6">
           <h3 className="text-2xl font-bold text-gray-900 font-display px-2">Frequently Asked Questions</h3>
           <div className="space-y-3">
              {faqs.map((faq, i) => (
                 <div key={i} className="rounded-2xl border border-gray-100 bg-white shadow-sm border border-gray-100 overflow-hidden">
                    <button 
                       onClick={() => setOpenFaq(openFaq === i ? null : i)}
                       className="w-full flex items-center justify-between p-6 text-left hover:bg-white/[0.02] transition-colors"
                    >
                       <span className="font-bold text-gray-900 text-sm">{faq.question}</span>
                       <ChevronDown className={cn("w-5 h-5 text-gray-500 transition-transform duration-300", openFaq === i && "rotate-180")} />
                    </button>
                    <div className={cn(
                       ...
                       <div className="min-h-0">
                          <p className="p-6 pt-0 text-sm text-gray-500 leading-relaxed">
                             {faq.answer}
                          </p>
                       </div>
                    </div>
        ...
        <div className="p-10 rounded-[40px] bg-[#146ef5] border border-gray-100 text-center space-y-6 relative overflow-hidden">
           <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                 <Button className="bg-emerald-600 text-white font-bold h-12 px-8 rounded-xl shadow-xl shadow-green/10">
                    <MessageSquare className="w-4 h-4 mr-2" /> Start a Chat
                 </Button>
                 <Button variant="outline" className="border-gray-100 text-gray-900 h-12 px-8 rounded-xl hover:bg-gray-50">
                    <Mail className="w-4 h-4 mr-2" /> Email Support
                 </Button>
              </div>
           </div>
           
           <div className="absolute top-0 right-0 w-64 h-64 bg-emerald-600/5 blur-[100px] -mr-32 -mt-32 rounded-full" />
