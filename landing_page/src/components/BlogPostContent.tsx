...
export default function BlogPostContent({ post }: { post: BlogPost }) {
  ...
  const handleCommentSubmit = async () => {
    ...
    try {
      const res = await fetch("https://resultsproserviceusers.vercel.app/api/v1/cms/blog/comments", {
        method: "POST",
  ...
  const handleSubscribeSubmit = async () => {
    ...
    setSubLoading(true);
    try {
      const res = await fetch("https://resultsproserviceusers.vercel.app/api/v1/cms/blog/subscribe", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
