                ...
                <div>
                  ...
                  <div className="mt-6 space-y-2.5 text-xs text-slate-600">
                    <div className="flex justify-between py-1 border-b border-slate-100">
                      ...
                      <span className="font-bold text-slate-900">{plan.students}</span>
                    </div>
                    <div className="flex justify-between py-1 border-b border-slate-100">
                      <span className="text-slate-400">Max Teachers:</span>
                      <span className="font-bold text-slate-900">{plan.teachers}</span>
                    </div>
                    <div className="flex justify-between py-1 border-b border-slate-100">
                      <span className="text-slate-400">Results / Term:</span>
                      <span className="font-bold text-slate-900">{plan.results}</span>
                    </div>
                    <div className="flex justify-between py-1 border-b border-slate-100">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm space-y-4">
          ...
          <div className="divide-y divide-slate-100 text-xs">
            <div className="py-3 flex items-center justify-between">
              <div>
                <p className="font-bold text-slate-900">INV-2026-001 • Greenwood High</p>
            ...
            <div className="py-3 flex items-center justify-between">
              <div>
                <p className="font-bold text-slate-900">INV-2026-002 • Kings College Lagos</p>
