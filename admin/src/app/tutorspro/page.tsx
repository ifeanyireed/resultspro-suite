            ...
            <tbody className="divide-y divide-slate-100">
              {tutors.map((t) => (
                <tr key={t.id} className="hover:bg-slate-50/80 transition-colors">
                  ...
                  <td className="px-4 py-3.5 font-bold text-slate-900">{t.rate}</td>
                  ...
                  <td className="px-4 py-3.5 font-bold text-slate-900">{t.lessons}</td>
                  <td className="px-4 py-3.5">
                    <Badge status={t.status} />
                  </td>
                  <td className="px-4 py-3.5 text-right space-x-2">
                    {t.status === 'PENDING' ? (
                      <button className="px-2.5 py-1 bg-emerald-600 text-white rounded font-semibold text-[11px] hover:bg-emerald-700">
                        Verify Tutor
                      </button>
                    ) : (
