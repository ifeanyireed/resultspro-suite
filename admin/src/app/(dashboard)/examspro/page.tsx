      ...
      <div className="p-8 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
            ...
            <p className="text-2xl font-medium text-slate-800 text-xs">5,820 Questions</p>
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
            ...
            <p className="text-2xl font-medium text-slate-800 text-xs">42 Concurrent Matches</p>
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-sm">
            ...
            <p className="text-2xl font-medium text-slate-800 text-xs">10,850 Candidates</p>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm space-y-4">
          <div className="flex justify-between items-center">
            ...
            <button className="bg-purple-600 text-white px-3.5 py-1.5 rounded-full text-xs font-bold hover:bg-purple-700 transition-colors flex items-center space-x-1.5">
              ...
              <tbody className="divide-y divide-slate-50">
                {exams.map((exam) => (
                  <tr key={exam.id} className="hover:bg-blue-50/30 transition-colors group">
                    <td className="px-4 py-3.5 font-medium text-slate-800 text-xs">{exam.name}</td>
