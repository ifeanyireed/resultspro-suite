    ...
    <div className="flex-1 flex flex-col bg-slate-50/50 min-h-full">
      ...
      <div className="p-8 space-y-8 max-w-[1400px] mx-auto w-full">
        <div className="flex justify-between items-center">
          ...
          <button className="bg-blue-600 text-white px-4 py-2 rounded-full text-xs font-bold hover:bg-blue-700 transition-colors flex items-center space-x-1.5 shadow-sm">
            ...
            <tbody className="divide-y divide-slate-50">
              {posts.map((p) => (
                <tr key={p.id} className="hover:bg-blue-50/30 transition-colors group">
                  ...
                  <td className="px-4 py-3.5 font-medium text-slate-800 text-xs">{p.views.toLocaleString()}</td>
