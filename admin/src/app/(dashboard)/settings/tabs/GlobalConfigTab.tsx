  ...
  return (
    <form onSubmit={handleSave} className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
          <div>
            ...
            <input
              type="text"
              defaultValue=`${process.env.NEXT_PUBLIC_USERS_API || ''}`
          ...
          <div>
            ...
            <input
              type="text"
              defaultValue=`${process.env.NEXT_PUBLIC_RESULTS_API || ''}`
              className="w-full bg-slate-50 border border-slate-200 rounded-lg p-2 text-slate-800"
            />
          </div>
          <div>
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          type="submit"
          className="bg-blue-600 text-white font-bold text-xs px-6 py-2.5 rounded-full hover:bg-blue-700 transition-colors shadow-sm"
        >
          Save Configuration
        </button>
      </div>
