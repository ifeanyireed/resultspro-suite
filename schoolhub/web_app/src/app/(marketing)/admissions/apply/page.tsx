  ...
  if (submitted) {
    return (
      <div style={{ height: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: 'var(--color-sky-blue)', color: 'white' }}>
        ...
        <p>Thank you for applying. Our admissions team will review your application and get back to you.</p>
  ...
  return (
    <>
      <HeroEditorial 
        ...
        subtitle="Moulding the tender life of a child since 1978. Join our family today."
        image="/photo01.jpeg"
        ctaText="Apply Now"
        ctaLink="#apply-form"
      />
      <section id="apply-form" className="section section-white">
        <div className="container">
          <ScrollReveal animation="fade-up">
            <h2>Admission Application</h2>
            <p>Please fill out the form below to begin the enrollment process for your child.</p>
          </ScrollReveal>
            ...
            <ScrollReveal animation="fade-up">
              <div style={{ 
                ...
                <form onSubmit={handleSubmit} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                  <h3 style={{ gridColumn: 'span 2', fontSize: '1.25rem', color: 'var(--color-sky-blue)', marginBottom: '0.5rem' }}>Student Information</h3>
                  <input 
                    type="text" 
