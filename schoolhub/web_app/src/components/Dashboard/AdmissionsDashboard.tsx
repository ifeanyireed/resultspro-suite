  ...
  return (
    <>
      ...
      <div className="flex items-end justify-between mb-8 mt-2">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 tracking-tight">Admissions CRM</h1>
          <p className="text-sm text-gray-500 mt-1">Track prospective families and enrollment pipeline.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
        ...
        <div className="bg-gradient-to-br from-[#146ef5] to-[#0a2e70] rounded-[1.5rem] p-6 shadow-sm shadow-[#146ef5]/10 flex flex-col justify-between aspect-square relative overflow-hidden group hover:-translate-y-1 transition-transform">
          ...
          <div className="flex justify-between items-start z-10">
            <h3 className="text-xl font-normal text-white">Total Inquiries</h3>
          ...
          <div className="z-10">
            <h2 className="text-5xl font-medium tracking-tight text-white mb-2">{pipelineData.total_inquiries}</h2>
        ...
        <div className="bg-white rounded-[1.5rem] p-6 shadow-sm border border-gray-100 flex flex-col justify-between aspect-square group hover:-translate-y-1 transition-transform">
          <div className="flex justify-between items-start">
            <h3 className="text-xl font-normal text-gray-900">Tours Scheduled</h3>
          ...
          <div>
            <h2 className="text-5xl font-medium tracking-tight text-gray-900 mb-2">{pipelineData.tours_scheduled}</h2>
        ...
        <div className="bg-white rounded-[1.5rem] p-6 shadow-sm border border-gray-100 flex flex-col justify-between aspect-square group hover:-translate-y-1 transition-transform">
          <div className="flex justify-between items-start">
            <h3 className="text-xl font-normal text-gray-900">Pending Review</h3>
            <div className="w-8 h-8 rounded-full border border-gray-200 flex items-center justify-center text-gray-400 group-hover:border-gray-900 group-hover:text-gray-900 transition-colors">
              <FolderOpenIcon className="w-4 h-4" />
            </div>
          </div>
          <div>
            <h2 className="text-5xl font-medium tracking-tight text-gray-900 mb-2">{pipelineData.applications_pending_review}</h2>
            <div className="flex items-center gap-1.5 text-xs text-gray-500">
              <span className="text-orange-500 font-semibold">Needs attention</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-[1.5rem] p-6 shadow-sm border border-gray-100 flex flex-col justify-between aspect-square group hover:-translate-y-1 transition-transform">
          <div className="flex justify-between items-start">
            <h3 className="text-xl font-normal text-gray-900">Admissions Offered</h3>
            <div className="w-8 h-8 rounded-full border border-gray-200 flex items-center justify-center text-gray-400 group-hover:border-gray-900 group-hover:text-gray-900 transition-colors">
              <CheckCircleIcon className="w-4 h-4" />
            </div>
          </div>
          <div>
            <h2 className="text-5xl font-medium tracking-tight text-gray-900 mb-2">{pipelineData.admissions_offered}</h2>
            <div className="flex items-center gap-1.5 text-xs text-gray-500">
              <span className="text-emerald-500 font-semibold">Awaiting acceptance</span>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-12 flex flex-col gap-3">
          ...
          <div className="bg-white rounded-[1.5rem] p-6 shadow-sm border border-gray-100">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-xl font-normal text-gray-900 tracking-tight">Recent Inquiries</h3>
              <button className="text-sm font-semibold text-[#146ef5] hover:underline">View CRM Pipeline</button>
            </div>
            <div className="flex flex-col gap-4">
              {inquiries.slice(0, 5).map((inquiry: any, i: number) => (
                <div key={i} className="flex items-center justify-between p-4 rounded-xl border border-gray-100 hover:bg-gray-50 transition-colors">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h4 className="text-base font-semibold text-gray-900">{inquiry.parent_name}</h4>
                      <p className="text-sm text-gray-500">Interested in Grade {inquiry.grade_interest} • {inquiry.date}</p>
                    </div>
                  </div>
                  <span className={`text-xs px-3 py-1 font-bold rounded-lg ${
                    inquiry.status === 'New' ? 'bg-blue-100 text-[#146ef5]' :
                    inquiry.status === 'Tour Scheduled' ? 'bg-yellow-100 text-yellow-700' :
