...
export default function PhotoHero({ title, subtitle, image, ctaText, ctaLink }: PhotoHeroProps) {
  return (
      ...
      <div className="container">
        <div className={styles.content}>
          <ScrollReveal animation="fade-up">
            <span className="caption" style={{ color: 'white', marginBottom: '1rem', display: 'block' }}>Official Announcement</span>
          </ScrollReveal>
