...
export default function FeatureSplit({ title, description, imageMain, imageSecondary, reverse }: FeatureSplitProps) {
  return (
      ...
      <div className={`container ${styles.grid} ${reverse ? styles.reverse : ''}`}>
        ...
        <div className={styles.content}>
          ...
          <ScrollReveal animation="fade-up" delay={600}>
            <a href="/academics" className={styles.link}>Explore Curriculum —</a>
          </ScrollReveal>
        </div>
      </div>
    </section>
