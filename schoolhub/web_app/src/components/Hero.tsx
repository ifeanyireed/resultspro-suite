          ...
          >
            ...
            <form aria-label="Quick Access" style={{ display: 'flex', flexDirection: 'column', gap: '0.875rem' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem', marginTop: '1rem' }}>
                <Link href="/school/login" className="btn btn-outline-white" style={{ width: '100%', justifyContent: 'center' }}>
                  <IconBook size={18} /> Solo
                </Link>
                <Link href="/admissions" className="btn btn-red" style={{ width: '100%', justifyContent: 'center', border: 'none' }}>
