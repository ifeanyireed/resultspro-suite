...
const dashboards = [
  { 
    ...
    name: 'Insights', 
    title: 'Insights Hub', 
    desc: 'School-wide analytics and intelligence.',
    apiRoute: '/admin/insights',
    metrics: ['Global Engagement', 'System Health', 'Active Users', 'Data Processed']
  },
  { 
    id: 'timetable', 
    name: 'Timetable', 
    title: 'Class Timetable', 
    desc: 'Master schedule and room allocation.',
    apiRoute: '/admin/timetable',
    metrics: ['Active Sessions', 'Room Utilization', 'Teacher Load', 'Conflicts']
  },
  { 
    id: 'fees', 
    name: 'Fees', 
    title: 'Fees & Finance', 
    desc: 'Manage tuition, invoices, and payroll.',
    apiRoute: '/admin/fees',
    metrics: ['Revenue (MTD)', 'Pending Invoices', 'Collection Rate', 'Total Expenses']
  },
  { 
    id: 'enrollment', 
    name: 'Enrollment', 
    title: 'Enrollment CRM', 
    desc: 'Monitor admissions and student growth.',
    apiRoute: '/admin/enrollment',
    metrics: ['Total Students', 'New Admissions', 'Retention Rate', 'Capacity']
  },
  { 
    id: 'transport', 
    name: 'Transport', 
    title: 'Transport & Fleet', 
    desc: 'Track school buses and driver schedules.',
    apiRoute: '/admin/transport',
    metrics: ['Active Buses', 'Routes Completed', 'Fuel Efficiency', 'Incidents']
  },
  { 
    id: 'procurement', 
    name: 'Procurement', 
    title: 'Procurement', 
    desc: 'Manage inventory and supply orders.',
    apiRoute: '/admin/procurement',
    metrics: ['Pending Orders', 'Inventory Value', 'Vendors', 'Monthly Spend']
  },
  { 
    id: 'library', 
    name: 'Library', 
    title: 'Library System', 
    desc: 'Manage books, digital assets, and loans.',
    apiRoute: '/admin/library',
    metrics: ['Total Assets', 'Active Loans', 'Overdue Items', 'New Acquisitions']
  },
  { 
    id: 'hostel', 
    name: 'Hostel', 
    title: 'Hostel Management', 
    desc: 'Monitor dormitories and boarding facilities.',
    apiRoute: '/admin/hostel',
    metrics: ['Total Beds', 'Occupancy Rate', 'Maintenance Alerts', 'Staff on Duty']
  },
  { 
    id: 'performance', 
    name: 'Performance', 
    title: 'Performance', 
    desc: 'Track staff and academic performance metrics.',
    apiRoute: '/admin/performance',
    metrics: ['Average Score', 'Top Performers', 'Appraisals Done', 'Goals Met']
  },
  { 
    id: 'operations', 
    name: 'Operations', 
    title: 'Operations Controls', 
    desc: 'Central command for campus facilities.',
    apiRoute: '/admin/operations',
    metrics: ['Open Tickets', 'Resolution Time', 'Active Staff', 'System Uptime']
  }
];
...
export default function ${d.name}Dashboard() {
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 mb-6">
        ...
        <div className="bg-gradient-to-br from-[#146ef5] to-[#0a2e70] rounded-[1.5rem] p-6 shadow-sm shadow-[#146ef5]/10 flex flex-col justify-between aspect-square relative overflow-hidden group hover:-translate-y-1 transition-transform">
          ...
          <div className="flex justify-between items-start z-10">
            <h3 className="text-xl font-normal text-white">${d.metrics[0]}</h3>
        ...
        <div className="bg-white rounded-[1.5rem] p-6 shadow-sm border border-gray-100 flex flex-col justify-between aspect-square group hover:-translate-y-1 transition-transform">
          <div className="flex justify-between items-start">
            <h3 className="text-xl font-normal text-gray-900">${d.metrics[1]}</h3>
        ...
        <div className="bg-white rounded-[1.5rem] p-6 shadow-sm border border-gray-100 flex flex-col justify-between aspect-square group hover:-translate-y-1 transition-transform">
          <div className="flex justify-between items-start">
            <h3 className="text-xl font-normal text-gray-900">${d.metrics[2]}</h3>
            <div className="w-8 h-8 rounded-full border border-gray-200 flex items-center justify-center text-gray-400 group-hover:border-gray-900 group-hover:text-gray-900 transition-colors">
        ...
        <div className="bg-white rounded-[1.5rem] p-6 shadow-sm border border-gray-100 flex flex-col justify-between aspect-square group hover:-translate-y-1 transition-transform">
          <div className="flex justify-between items-start">
            <h3 className="text-xl font-normal text-gray-900">${d.metrics[3]}</h3>
            <div className="w-8 h-8 rounded-full border border-gray-200 flex items-center justify-center text-gray-400 group-hover:border-gray-900 group-hover:text-gray-900 transition-colors">
...
`;
  ...
  fs.writeFileSync(`src/app/(portal)${d.apiRoute}/page.tsx`, code);
});
console.log('Successfully generated all Operations dashboards matching reference UI styling.');
